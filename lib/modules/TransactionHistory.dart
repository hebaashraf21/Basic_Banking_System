  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<BankCubit,BankSatates>(
      ...
      var cubit=BankCubit.get(context);
        return Scaffold(
      appBar: AppBar(title: Center(child: Text("Transactions History",style:TextStyle(fontWeight: FontWeight.w100,color: primary,fontFamily: 'Lobster',fontSize: 30)),)),
      body: Padding(padding: EdgeInsets.all(7),
      child: transactionsList(transactions: cubit.transactionsHistory)),
